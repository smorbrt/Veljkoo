const bot = function () {
    ...
    const ankibot = document.getElementById('ankibot');
    const container = document.getElementById('ankibot-container');
    const inner = document.getElementById('ankibot-inner');
    ...
    const insertNewChatItem = function (elem) {
        //container.insertBefore(elem, ankibot);
        ankibot.appendChild(elem);
        scrollContainer();
        //debugger;
    ...
    const handleChoice = async function (e) {
        ...
        if (!e.target.classList.contains('choice') || 'A' === e.target.tagName) {
            ...
            var button = e.target.closest('#ankibot-container .choice');
...
bot();  //ovim se poziva botic bez ovog belo prozorce