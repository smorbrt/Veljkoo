/*The chat const defines the ankibot conversation.
...
const chat = {
    ...
    2: {
        text: 'AnkiBot is a <em>really simple</em>, choice-driven chatbot framework made in <del>less than</del> just over 100 lines of vanilla JavaScript',
        next: 3
    },
    3: {
    ...
    6: {
        ...
        options: [
            {
                text: "Go to GitHub",
                url: "https://github.com/ankibot/ankibot"
            }
        ]
    }
};